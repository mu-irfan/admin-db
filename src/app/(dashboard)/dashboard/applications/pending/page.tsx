          ...
          >
            ...
            <CardContent className="p-4 space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-gray-500">{project?.title || "N/A"}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-semibold text-gray-700">Trade:</span>
                <span className="text-gray-500">{project?.trade || "N/A"}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex gap-2 justify-end">
                {application.status === "pending" && (
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => handleApplicationApprove(application.uuid)}
